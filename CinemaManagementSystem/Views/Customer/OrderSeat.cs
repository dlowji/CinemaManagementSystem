...
namespace CinemaManagementSystem.View.Customer
{
    public partial class OrderSeat : UserControl
    {
        ...
        LichChieu Times;
        Phim Movie;
        public OrderSeat(LichChieu showTimes, Phim movie, string customerId, Panel homepage)
        {
            InitializeComponent();
        ...
        private void btnNext_Click(object sender, EventArgs e)
        {
            ...
            FoodDrinkUC foodDrinkUC = new FoodDrinkUC(customerId, listSeatSelected, Times, Movie, total, homepage);
