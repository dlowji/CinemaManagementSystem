...
{
    public partial class FoodDrinkUC : UserControl
    {
        ...
        public FoodDrinkUC(string customerId, List<Button> selectedSeat, LichChieu showTimes, Phim movie, decimal totalTicketPrice, Panel homepage)
        {
            InitializeComponent();
        ...
        {
            DialogResult result = MessageBox.Show("Xóa danh sách vừa chọn?", "Xác nhận", MessageBoxButtons.YesNoCancel);
