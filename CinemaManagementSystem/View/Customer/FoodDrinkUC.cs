...
namespace CinemaManagementSystem.View.Customer
{
    public partial class FoodDrinkUC : UserControl
    {
        ...
        public FoodDrinkUC(string staffId, List<Button> selectedSeat, LichChieu showTimes, Phim movie, decimal totalTicketPrice, Panel homepage)
        {
            InitializeComponent();
        ...
        {
            BillUC billUC = new BillUC(selectedSeat, supports, showTimes, movie, totalTicketPrice);
